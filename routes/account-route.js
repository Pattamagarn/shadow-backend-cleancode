...
const { validationAccount, signUpAccount, signInAccount, signOutAccount, authenticationAccount, selectAccount, updateStatusAccount } = require('../controllers/account-controller')
